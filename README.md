...
|---------|-----------|-------------|
|__rswag3-specs__|Swagger-based DSL for rspec & accompanying rake task for generating Swagger files|_spec/swagger_helper.rb_|
|__rswag3-api__  |Rails Engine that exposes your Swagger files as JSON endpoints|_config/initializers/rswag3-api.rb, config/routes.rb_|
|__rswag3-ui__   |Rails Engine that includes [swagger-ui](https://github.com/swagger-api/swagger-ui) and powers it from your Swagger endpoints|_config/initializers/rswag3-ui.rb, config/routes.rb_|
...
TestApp::Application.routes.draw do
  ...
  mount Rswag3::Api::Engine => 'your-custom-prefix'
end
```
...
TestApp::Application.routes.draw do
  ...
  mount Rswag3::Ui::Engine => 'your-custom-prefix'
end
```
